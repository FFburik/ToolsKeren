...
get_sms=$(curl -s http://zlucifer.com/api/FFBurik.php?request=sms)
get_call=$(curl -s http://zlucifer.com/api/FFBurik.php?request=call)
mulai (){
...
clear
troll
echo Selamat datang Asu, Siapa nick kaka? #tulisan keluar
